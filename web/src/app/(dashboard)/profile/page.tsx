    ...
    <div className="w-full h-fit grid grid-cols-10 gap-2 mb-12">
      ...
      <div className="col-span-7 flex flex-col gap-2">
        <div className="bg-white rounded-xl p-4 pb-12 border border-slate-300 flex flex-col gap-6">
          <h2 className="text-xl font-bold text-slate-700">Profile Information</h2>
          {/* About You Section */}
          <div>
            <h3 className="text-md font-bold text-fuchsia-700 mb-2">About You</h3>
            <div className="grid grid-cols-2 gap-x-6 gap-y-2">
              ...
              <div className="flex flex-row items-center gap-2">
                <span className="font-bold text-sm text-slate-500">Username</span>
              ...
              <div className="flex flex-row items-center gap-2">
                <span className="font-bold text-sm text-slate-500">Full Name</span>
              ...
              <div className="flex flex-row items-center gap-2">
                <span className="font-bold text-sm text-slate-500">Account Created</span>
          ...
          {/* Your Room Section */}
          <div>
            <h3 className="text-md font-bold text-fuchsia-700 mb-2">Your Room</h3>
            {/* Renting status - first info */}
            <div className="mb-2">
              <div className="flex flex-row items-center gap-2">
                <span className="font-bold text-xs text-slate-500">Renting</span>
            ...
            {true && (
              <>
                <div className="grid grid-cols-2 gap-x-6 gap-y-2">
                  <div className="flex flex-row items-center gap-2">
                    <span className="font-bold text-xs text-slate-500">Room Number</span>
                    <span className="text-xs text-slate-600">101</span>
                  </div>
                  <div className="flex flex-row items-center gap-2">
                    <span className="font-bold text-xs text-slate-500">Floor</span>
                    <span className="text-xs text-slate-600">1</span>
                  </div>
                  <div className="flex flex-row items-center gap-2">
                    <span className="font-bold text-xs text-slate-500">Type</span>
                    <span className="text-xs text-slate-600">Studio</span>
                  </div>
                  <div className="flex flex-row items-center gap-2">
                    <span className="font-bold text-xs text-slate-500">Status</span>
                    <span className="text-xs text-slate-600">Occupied</span>
                  </div>
                  <div className="flex flex-row items-center gap-2">
                    <span className="font-bold text-xs text-slate-500">Base Rent</span>
                    <span className="text-xs text-slate-600">₱12,000.00</span>
                  </div>
                  <div className="flex flex-row items-center gap-2">
                    <span className="font-bold text-xs text-slate-500">Lease Period</span>
                    <span className="text-xs text-slate-600">2026-01-01 to 2026-12-31</span>
                  </div>
                </div>
                {/* Your Payments Section */}
                <div className="mt-6">
                  <h3 className="text-md font-bold text-fuchsia-700 mb-2">Your Payments</h3>
                  <div className="grid grid-cols-2 gap-x-6 gap-y-2">
                    <div className="flex flex-row items-center gap-2">
                      <span className="font-bold text-xs text-slate-500">Total Payments</span>
                      <span className="text-xs text-slate-600">12</span>
                    </div>
                    <div className="flex flex-row items-center gap-2">
                      <span className="font-bold text-xs text-slate-500">Overdue Payments</span>
                      <span className="text-xs text-slate-600">1</span>
                    </div>
                    <div className="flex flex-row items-center gap-2">
                      <span className="font-bold text-xs text-slate-500">Total Amount Paid</span>
                      <span className="text-xs text-slate-600">₱120,000.00</span>
                    </div>
                    <div className="flex flex-row items-center gap-2">
                      <span className="font-bold text-xs text-slate-500">Outstanding Balance</span>
                      <span className="text-xs text-slate-600">₱12,000.00</span>
                    </div>
                  </div>
                </div>
      ...
      <div className="col-span-3 flex flex-col gap-2">
        <div className="bg-white rounded-xl p-4 border border-slate-300 flex flex-col h-full">
          <h2 className="text-md font-bold text-slate-700 mb-4">Profile Actions</h2>
