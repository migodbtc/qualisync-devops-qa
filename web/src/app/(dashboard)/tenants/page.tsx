      ...
      <div className='col-span-7 flex flex-col gap-2'>
        <div className='bg-white h-16 rounded-xl p-2 border border-slate-300 flex items-center justify-between'>
          ...
          <div className='flex flex-row gap-2 ml-auto'>
            <button className='h-9 px-4 rounded-xl font-semibold text-xs bg-fuchsia-700 text-white shadow hover:bg-fuchsia-800 transition-colors cursor-pointer'>
              Add Tenant
            </button>
      ...
      <div className='col-span-3 flex flex-col gap-1'>
        ...
        <div className='bg-white rounded-xl p-4 py-8 border border-slate-300 flex flex-col justify-center mb-2'>
          ...
          <span className='text-xs text-slate-500 text-left'>
            Number of tenants currently registered on the Fuchsia ATMS
          </span>
        </div>
        ...
        <div className='bg-white rounded-xl p-4 border border-slate-300 flex flex-col'>
          ...
          <div className='flex flex-col gap-2 mb-2'>
            ...
            <div className='flex flex-row justify-between items-center text-sm text-slate-500'>
              ...
              <span className='truncate max-w-35 text-slate-800'>
                Johnathan Doe the First
              </span>
            </div>
            <div className='flex flex-row justify-between items-center text-sm text-slate-500'>
          ...
          <div className='flex flex-row gap-2 mt-2'>
            ...
            <button className='h-9 px-4 rounded-xl font-semibold text-xs bg-white border border-slate-300 text-red-600 hover:bg-red-50 transition-colors cursor-pointer'>
              Delete
            </button>
          </div>
        </div>
