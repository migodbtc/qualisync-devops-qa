...
export default function FinancePage() {
  ...
  React.useEffect(() => {
    function handleGrowthClick(e: MouseEvent) {
      if (growthDropdownRef.current && !growthDropdownRef.current.contains(e.target as Node)) {
              ...
              <div ref={dropdownRef} className="absolute top-3 right-4 z-30">
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-1 w-36 bg-white border border-slate-200 rounded-lg shadow-lg py-1 z-40">
                    {["Weekly", "Monthly", "Yearly", "Since Start"].map((scope) => (
                      <button
                        key={scope}
          ...
          <div className="mt-4 grid grid-cols-1 gap-1">
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div className="flex items-center gap-1">
                ...
                <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-green-600"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="text-slate-700 font-bold">Avg. Monthly Revenue</div>
