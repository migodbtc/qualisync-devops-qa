...
- [ ] **Database & Backend Implementation (Code-First Approach)**
    ...
    - Define a Python Class `AuthUser` in `models.py`.
    - **Challenge:** Do not create the table in MySQL Workbench. Use `db.create_all()` inside your Flask app context to generate the table automatically upon startup.
